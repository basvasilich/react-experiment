...
app.spaceSwitcher = React.createClass({displayName: 'spaceSwitcher',
    ...
    render: function() {
        ...
        return (
            /* jshint ignore:start */
            React.DOM.div({ref: "spaceSwitcher", className: className}, 
                React.DOM.a({href: "#", className: "header__a space-switcher__toggler", onClick:  this.handleClick}, "Go to space"), 

                React.DOM.div({ref: "spaceSwitcherBody", className: "space-switcher__body"}, 
                    React.DOM.div({ref: "spaceSwitcherHeader", className: "space-switcher__header "}, 
                        React.DOM.div({className: "space-switcher__form"}, 
                            app.spaceSwitcherForm({state:  this.state, handleSearch:  this.handleSearch})
                        )
                    ), 
                    React.DOM.div({ref: "spaceSwitcherList", className: "space-switcher__list"}, 
...
app.spaceSwitcherForm = React.createClass({displayName: 'spaceSwitcherForm',
    ...
    render: function() {
        return (
            /* jshint ignore:start */
            React.DOM.form({className: "space-switcher__form__i"}, 
                React.DOM.input({type: "search", autoComplete: "off", ref: "spaceSwitcherSearchText", onInput: this.handleInput, type: "text", className: "space-switcher__search-text", name: "space-switcher__search-text"})
            )
            /* jshint ignore:end */
            );
    }
...
app.spaceSwitcherList = React.createClass({displayName: 'spaceSwitcherList',
    render: function() {
        ...
        return (
            /* jshint ignore:start */
            React.DOM.div({className: "space-switcher__list__i"}, 
                organisationsNode
            )
            /* jshint ignore:end */
            );
...
app.spaceSwitcherOrganisation = React.createClass({displayName: 'spaceSwitcherOrganisation',
    render: function() {
        ...
        return (
            /* jshint ignore:start */
            React.DOM.div({className: className, style: {'background-image': backgroundImage}}, 
                React.DOM.div({dangerouslySetInnerHTML: {__html: name}, className: "space-switcher__organisation-title"}), 
                React.DOM.div({className: "space-switcher__spaces"}, 
    ...
    render: function() {
        ...
        return (
            ...
            React.DOM.div({className: className}, 
                React.DOM.a({dangerouslySetInnerHTML: {__html: name}, href:  space.url, className: "space-switcher__space-title space-switcher__a"})
            )
            /* jshint ignore:end */
            );
    }
